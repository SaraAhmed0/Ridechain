...
class Ticket: Codable, Identifiable {
    ...
    static let demoTicket = Ticket(relatedRide: "", totaltickets: 0, invoiceNo: 0, time : Date(), date : Date(), duration : 0, price : 0.0, dropoff : "King Abdulaziz", pickup : "AlTakhassusi", type : "")
}
